<template>
	<view>
		<template v-if="!loginStatus">
			<!-- 未登录 -->
			<view class="u-f-ajc">登陆社区，体验更多功能</view>
			<!-- 第三方登陆 -->
		...
		<view class="home-adv u-f-ajc animated fadeIn fast" >
			<image src="https://tangzhe123-com.oss-cn-shenzhen.aliyuncs.com/Appstatic/qsbk/demo/banner1.jpg" mode="aspectFill" lazy-load class="rounded" style="height: 200rpx;"></image>
		</view>
		<!-- 数据 -->
		...
		data() {
			return {
				...
				list:[
					...
					{ icon:"huiyuanvip",name:"社区认证",clicktype:"nothing",url:"" },
					{ icon:"keyboard",name:"审核帖子",clicktype:"nothing",url:"" },
					// #ifndef APP-PLUS
