<template>
	<view>
		...
		<view class="flex justify-center main-light-dark" style="margin-top: 200rpx;margin-bottom: 60rpx;">
		...
		<!-- 登录状态切换 -->
		<view class="u-f-ajc mt-4">
			<view class="login-padding" style="color: #33677B;"
			@tap="changeStatus" hover-class="text-hover-primary">
				{{status?'账号密码登录':'验证码登录'}}
			</view>
			<text class="login-font-color mx-2">|</text>
			<view class="login-padding"  style="color: #33677B;"
		...
		<!-- 第三方登陆 -->
		<view class="other-login-title u-f-ajc login-padding login-font-color">社交账号登录</view>
		<other-login :noback="false"></other-login>
		
		<!-- 协议 -->
		<view class="login-rule u-f-ajc login-padding login-font-color">
			注册即代表您同意<view class="text-primary">《XXX社区协议》</view>
		</view> 
