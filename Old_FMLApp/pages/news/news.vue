		...
		@change="tabChange">
			...
			<swiper-item> 
				<scroll-view scroll-y class="list">
					...
					<!-- 搜索框 -->
					<view class="p-2 border-top border-light-secondary">
						<view class="rounded u-f-ajc p-2 main-light-dark"
						style="background: #F5F4F3;" @tap="openSearch">
							<text class="mr-2 iconfont icon-sousuo topic-search" 
							></text> 搜索话题
						</view>
					</view>
					<!-- 轮播图 -->
					<swiper class="topic-swiper rounded" :indicator-dots="true" :autoplay="true" :interval="3000" :duration="1000" :style="getSwiperHeight">
						<block v-for="(item,index) in topic.swiper" :key="index">
							<swiper-item :style="getSwiperHeight">
								<image :src="item.src" lazy-load
								style="width: 100%;height: 300rpx;"></image>
							</swiper-item>
						</block>
					</swiper>
					<divider></divider>
					<!-- 最近更新 -->
					<view class="topic-new py-2">
						<view class="px-2 pb-1">最近更新</view>
