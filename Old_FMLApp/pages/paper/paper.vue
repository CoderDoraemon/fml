<template>
	<view class="body">
		...
		<uni-popup ref="popup" type="top">
			<view class="u-f-ajc py-2 animated faster font-md border-bottom border-light-secondary" hover-class="pulse main-color" @tap="addfriend">
				<text class="iconfont icon-sousuo mr-2"></text>
				加好友
			</view>
			<view class="u-f-ajc py-2 animated faster font-md"
			hover-class="pulse main-color" @tap="clear">
