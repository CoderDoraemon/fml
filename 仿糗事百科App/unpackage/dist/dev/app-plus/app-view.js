...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'index-list u-f-column data-v-023f94ea'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'paper-list u-f-ac'])
Z([3,'u-f-sh'])
Z([3,'widthFix'])
Z([3,'../../static/tabbar/home.png'])
Z([3,'u-f-column u-f1'])
Z([3,'u-f-ac u-f-jsb'])
Z([3,'u-line-one'])
Z([3,'昵称昵称昵称昵称昵称昵称昵昵称昵称昵昵称昵称昵昵称昵称昵'])
Z([3,'13：58'])
Z(z[5])
Z([3,'详情'])
Z([3,'__l'])
...
var x=['./components/common/load-more.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./components/uni-badge/uni-badge.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/publish/publish.wxml','./pages/search/search.wxml','./pages/user-chat/user-chat.wxml'];d_[x[0]]={}
...
var xWB=_mz(z,'text',['bindtap',1,'class',1,'data-event-opts',2],[],e,s,gg)
...
var a6B=_mz(z,'uni-status-bar',['bind:__l',4,'vueId',1],[],e,s,gg)
_(l5B,a6B)
}
var t7B=_mz(z,'view',['class',6,'style',1],[],e,s,gg)
var e8B=_mz(z,'view',['bindtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
var b9B=_v()
_(e8B,b9B)
if(_oz(z,11,e,s,gg)){b9B.wxVkey=1
var xAC=_n('view')
var oBC=_mz(z,'uni-icon',['bind:__l',12,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(xAC,oBC)
_(b9B,xAC)
}
var o0B=_v()
...
cGC.wxXCkey=1
_(t7B,oFC)
var tKC=_mz(z,'view',['bindtap',25,'class',1,'data-event-opts',2],[],e,s,gg)
var eLC=_v()
_(tKC,eLC)
if(_oz(z,28,e,s,gg)){eLC.wxVkey=1
var oNC=_n('view')
var xOC=_mz(z,'uni-icon',['bind:__l',29,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(oNC,xOC)
_(eLC,oNC)
}
var bMC=_v()
...
var c3B=_v()
_(o2B,c3B)
if(_oz(z,38,e,s,gg)){c3B.wxVkey=1
var hSC=_n('view')
_rz(z,hSC,'class',39,e,s,gg)
var oTC=_v()
_(hSC,oTC)
if(_oz(z,40,e,s,gg)){oTC.wxVkey=1
var cUC=_mz(z,'uni-status-bar',['bind:__l',41,'vueId',1],[],e,s,gg)
_(oTC,cUC)
}
var oVC=_n('view')
...
var z=gz$gwx_9()
var x3C=_n('view')
var o4C=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'itemWidth',2,'tabBars',3,'tabIndex',4,'vueId',5],[],e,s,gg)
_(x3C,o4C)
var f5C=_n('view')
_rz(z,f5C,'class',7,e,s,gg)
var c6C=_mz(z,'swiper',['bindchange',8,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var h7C=_v()
_(c6C,h7C)
var o8C=function(o0C,c9C,lAD,gg){
var tCD=_n('swiper-item')
var eDD=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',17,'class',1,'data-event-opts',2],[],o0C,c9C,gg)
var bED=_v()
_(eDD,bED)
var oFD=function(oHD,xGD,fID,gg){
var hKD=_mz(z,'index-list',['bind:__l',24,'item',1,'vueId',2],[],oHD,xGD,gg)
_(fID,hKD)
return fID
}
bED.wxXCkey=4
_2z(z,22,oFD,o0C,c9C,gg,bED,'item','row','row')
var oLD=_mz(z,'load-more',['bind:__l',27,'loadtext',1,'vueId',2],[],o0C,c9C,gg)
_(eDD,oLD)
_(tCD,eDD)
_(lAD,tCD)
return lAD
...
h7C.wxXCkey=4
_2z(z,15,o8C,e,s,gg,h7C,'items','index','index')
_(f5C,c6C)
_(x3C,f5C)
_(r,x3C)
return r
...
var eRD=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(tQD,eRD)
var bSD=_n('view')
...
_(hYD,oZD)
var c1D=_mz(z,'uni-badge',['bind:__l',11,'text',1,'type',2,'vueId',3,'vueSlots',4],[],e,s,gg)
...
var z=gz$gwx_12()
var a4D=_n('view')
var t5D=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickLeft',1,'bind:clickRight',1,'data-event-opts',2,'leftIcon',3,'rightText',4,'statusBar',5,'vueId',6,'vueSlots',7],[],e,s,gg)
