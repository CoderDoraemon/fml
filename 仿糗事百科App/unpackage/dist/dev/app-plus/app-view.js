...
var x=['./components/common/load-more.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/publish/publish.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var lY=_mz(z,'image',['class',27,'mode',1,'src',2],[],e,s,gg)
_(oX,lY)
var aZ=_n('view')
...
var oJB=_mz(z,'scroll-view',['scrollX',-1,'class',1],[],e,s,gg)
var fKB=_v()
_(oJB,fKB)
var cLB=function(oNB,hMB,cOB,gg){
var lQB=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],oNB,hMB,gg)
var aRB=_oz(z,9,oNB,hMB,gg)
_(lQB,aRB)
var tSB=_n('view')
_rz(z,tSB,'class',10,oNB,hMB,gg)
_(lQB,tSB)
_(cOB,lQB)
return cOB
}
fKB.wxXCkey=2
_2z(z,4,cLB,e,s,gg,fKB,'tab','index','id')
_(xIB,oJB)
_(r,xIB)
return r
}
...
var z=gz$gwx_4()
var bUB=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1,'style',2],[],e,s,gg)
_(r,bUB)
return r
}
...
var fYB=_mz(z,'view',['class',1,'style',1],[],e,s,gg)
var cZB=_v()
_(fYB,cZB)
if(_oz(z,3,e,s,gg)){cZB.wxVkey=1
var h1B=_mz(z,'uni-status-bar',['bind:__l',4,'vueId',1],[],e,s,gg)
_(cZB,h1B)
}
var o2B=_mz(z,'view',['class',6,'style',1],[],e,s,gg)
var c3B=_mz(z,'view',['bindtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
var o4B=_v()
_(c3B,o4B)
if(_oz(z,11,e,s,gg)){o4B.wxVkey=1
var a6B=_n('view')
var t7B=_mz(z,'uni-icon',['bind:__l',12,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(a6B,t7B)
_(o4B,a6B)
}
var l5B=_v()
...
var oBC=_v()
_(xAC,oBC)
if(_oz(z,22,e,s,gg)){oBC.wxVkey=1
var fCC=_n('view')
...
oBC.wxXCkey=1
_(o2B,xAC)
var oFC=_mz(z,'view',['bindtap',25,'class',1,'data-event-opts',2],[],e,s,gg)
var cGC=_v()
_(oFC,cGC)
if(_oz(z,28,e,s,gg)){cGC.wxVkey=1
var lIC=_n('view')
var aJC=_mz(z,'uni-icon',['bind:__l',29,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(lIC,aJC)
_(cGC,lIC)
}
var oHC=_v()
_(oFC,oHC)
if(_oz(z,34,e,s,gg)){oHC.wxVkey=1
var tKC=_n('view')
...
var oPC=_mz(z,'uni-status-bar',['bind:__l',41,'vueId',1],[],e,s,gg)
_(xOC,oPC)
}
var fQC=_n('view')
...
var z=gz$gwx_8()
var aXC=_n('view')
var tYC=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'itemWidth',2,'tabBars',3,'tabIndex',4,'vueId',5],[],e,s,gg)
_(aXC,tYC)
var eZC=_n('view')
_rz(z,eZC,'class',7,e,s,gg)
var b1C=_mz(z,'swiper',['bindchange',8,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var o2C=_v()
_(b1C,o2C)
var x3C=function(f5C,o4C,c6C,gg){
var o8C=_n('swiper-item')
var c9C=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',17,'class',1,'data-event-opts',2],[],f5C,o4C,gg)
var o0C=_v()
_(c9C,o0C)
var lAD=function(tCD,aBD,eDD,gg){
var oFD=_mz(z,'index-list',['bind:__l',24,'item',1,'vueId',2],[],tCD,aBD,gg)
_(eDD,oFD)
return eDD
}
o0C.wxXCkey=4
_2z(z,22,lAD,f5C,o4C,gg,o0C,'item','row','row')
var xGD=_mz(z,'load-more',['bind:__l',27,'loadtext',1,'vueId',2],[],f5C,o4C,gg)
_(c9C,xGD)
_(o8C,c9C)
_(c6C,o8C)
return c6C
...
o2C.wxXCkey=4
_2z(z,15,x3C,e,s,gg,o2C,'items','index','index')
_(eZC,b1C)
_(aXC,eZC)
_(r,aXC)
return r
...
var z=gz$gwx_11()
var cMD=_n('view')
var oND=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickLeft',1,'bind:clickRight',1,'data-event-opts',2,'leftIcon',3,'rightText',4,'statusBar',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var lOD=_mz(z,'view',['bindtap',9,'class',1,'data-event-opts',2],[],e,s,gg)
